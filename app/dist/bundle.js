...
module.exports = __webpack_require__(/*! /Users/newmatt/Dropbox/projects/dnamazing/app/src/main.js */334);
...
__webpack_require__(/*! p2 */ 129);

var _phaser = __webpack_require__(/*! phaser */ 50);
...
var _config = __webpack_require__(/*! ./config */ 347);
...
var Game = function (_Phaser$Game) {
  ...
  function Game() {
    ...
    var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, width - 104, height, _phaser2.default.CANVAS, 'content', '', true));
...
var _webfontloader = __webpack_require__(/*! webfontloader */ 130);
...
var _jquery = __webpack_require__(/*! jquery */ 92);

var _jquery2 = _interopRequireDefault(_jquery);

var _underscore = __webpack_require__(/*! underscore */ 93);

var _underscore2 = _interopRequireDefault(_underscore);

var _HudView = __webpack_require__(/*! ./HudView */ 343);

var _HudView2 = _interopRequireDefault(_HudView);

var _genome = __webpack_require__(/*! ../../assets/data/genome */ 346);
...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    value: function create() {
      ...
      this.$htmlWrapper = (0, _jquery2.default)("#html-wrapper");
      this.$htmlWrapper.append(this.hudView.$el);

      this.myId = null;
      localStorage.clear();

      var myIdString = localStorage.getItem("my_id");
      if (myIdString) {
      ...
      if (this.myId) {
        ...
        var myInitialColor = game.rnd.integerInRange(0, this.colors.length - 1);
    ...
    key: 'updateThumbsForever',
    value: function updateThumbsForever() {
      ...
      if (this.isBusyThumbnailGetting !== true) {
        ...
        _jquery2.default.ajax({
          ...
          "success": function success(response) {
            ...
            for (var i = 0; i < parsed.allUsers.length; i++) {
    ...
    key: 'drawingAlgo',
    value: function drawingAlgo(node, w, h, x, y, depth, maxDepth, startGroup) {
    ...
    key: 'drawingAlgo2',
    value: function drawingAlgo2(node, w, h, x, y, depth, maxDepth, startGroup) {
    ...
    key: 'createUserButtons',
    value: function createUserButtons(userList) {
    ...
    key: 'doMate',
    value: function doMate(otherUserId) {

      var otherUserData = _underscore2.default.findWhere(this.allUsers, { id: "" + otherUserId + "" });
      ...
      if (otherUserData) {
        ...
        var trimmedTree = this.trimTree(newTree, 0);
        ...
        var myGenomeString = JSON.stringify(this.myGenome);

        var url = "http://35.227.37.79/dnaapi.php";
    ...
    key: 'trimTree',
    value: function trimTree(someTree, depth) {

      var newTree = {
        "cc": someTree.cc
      };

      if (depth < this.maxTreeDepth && typeof someTree["1"] !== "undefined" && typeof someTree["0"] !== "undefined") {
    ...
    key: 'calculateMaxDepth',
    value: function calculateMaxDepth() {
      var biggest = Math.max(game.width, game.height);
      this.maxDepth = Math.log(biggest) / Math.log(2) + 6;

      console.log("max screen size, maxDepth, maxTreeDepth = ", biggest, this.maxDepth, this.maxTreeDepth);
    }
  }]);
...
var _backbone = __webpack_require__(/*! backbone */ 344);
...
var mainTemplate = __webpack_require__(/*! html-loader?root=.!./HudTemplate.html */ 345);
...
var _class = function (_View) {
	...
	function _class(_ref) {
		...
		_this.state = state;
		_this.template = _underscore._.template(mainTemplate);
	...
	_createClass(_class, [{
		...
		value: function renderUserButtons(userList) {
			var _this2 = this;
			...
			var _loop = function _loop(i) {
				var user = userList[i];
				var newButton = (0, _jquery2.default)("<button style=\"background-image: url(" + user.dataUrl + ");\" data-user-id=\"" + user.id + "\" ></button>");
...
(function(factory) {
  ...
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! underscore */ 93), __webpack_require__(/*! jquery */ 92), exports], __WEBPACK_AMD_DEFINE_RESULT__ = (function(_, $, exports) {
...
/* 345 */
/*!***********************************************************************!*\
  !*** ./node_modules/html-loader?root=.!./src/states/HudTemplate.html ***!
  \***********************************************************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports) {
...
/* 346 */
/*!*********************************!*\
  !*** ./assets/data/genome.json ***!
  \*********************************/
/*! dynamic exports provided */
/*! all exports used */
/***/ (function(module, exports) {

module.exports = {"0":{"0":{"color":0},"1":{"0":{"0":{"color":1},"1":{"color":2}},"1":{"color":3}}},"1":{"0":{"0":{"color":1},"1":{"0":{"0":{"color":0},"1":{"0":{"0":{"color":1},"1":{"color":2}},"1":{"color":3}}},"1":{"0":{"0":{"color":1},"1":{"color":2}},"1":{"color":3}}}},"1":{"color":3}}}
