...
var _class = function (_Phaser$State) {
  ...
  _createClass(_class, [{
    ...
    key: 'drawingAlgoMatt',
    value: function drawingAlgoMatt(node, w, h, x, y, depth, maxDepth, startGroup) {
    ...
    key: 'drawingAlgoSpiral',
    value: function drawingAlgoSpiral(node, w, h, x, y, depth, maxDepth, startGroup) {
    ...
    key: 'drawingAlgo1',
    value: function drawingAlgo1(node, w, h, x, y, depth, maxDepth, startGroup) {
    ...
    value: function trimTree(someTree, depth) {
      ...
      if (depth <= this.maxTreeDepth + 1 && typeof someTree["1"] !== "undefined" && typeof someTree["0"] !== "undefined") {
